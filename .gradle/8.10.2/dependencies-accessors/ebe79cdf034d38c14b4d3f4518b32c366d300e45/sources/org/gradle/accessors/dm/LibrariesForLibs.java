...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    /**
     * Dependency provider for <b>javafx</b> with <b>org.openjfx:javafx</b> coordinates and
     * with version reference <b>javafx</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     */
    public Provider<MinimalExternalModuleDependency> getJavafx() {
        return create("javafx");
    }
    ...
    /**
     * Group of libraries at <b>apollo</b>
     */
    ...
    /**
     * Group of libraries at <b>coroutine</b>
     */
    ...
    public static class ApolloLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>runtime</b> with <b>com.apollographql.apollo:apollo-runtime</b> coordinates and
         * with version reference <b>apollo</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getRuntime() {
    ...
    public static class CoroutineLibraryAccessors extends SubDependencyFactory {
        ...
        public Provider<MinimalExternalModuleDependency> getViewmodel() {
            return create("coroutine.viewmodel");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>apollo</b> with value <b>4.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>javafx</b> with value <b>17.0.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>mockk</b> with value <b>1.13.7</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>viewmodel</b> with value <b>2.6.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class ComposeVersionAccessors extends VersionFactory  implements VersionNotationSupplier {
        ...
        /**
         * Version alias <b>compose.runtime</b> with value <b>runtime</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class CoroutinesVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>coroutines.test</b> with value <b>1.7.3</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class MockitoVersionAccessors extends VersionFactory  implements VersionNotationSupplier {
        ...
        /**
         * Version alias <b>mockito.kotlin</b> with value <b>5.2.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class PluginAccessors extends PluginFactory {
        ...
        /**
         * Plugin provider for <b>apollo</b> with plugin id <b>com.apollographql.apollo</b> and
         * with version reference <b>apollo</b>
         * <p>
         ...
         * with version <b>1.9.21-1.0.15</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
